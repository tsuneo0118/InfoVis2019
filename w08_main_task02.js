function main()
{
	...
	var S00 = S0 - 0.1;
	S00 = S00 * 255;
	S00 = Math.round(S00 / 0.7);
	var S01 = S1 - 0.1;
	S01 = S01 * 255;
	S01 = Math.round(S01 /0.7);
	var S02 = S2 - 0.1;
	S02 = S02 * 255
	S02 = Math.round(S02/0.7);

	
        var C0 = new THREE.Color().setHex( cmap[ S00 ][1] );
        var C1 = new THREE.Color().setHex( cmap[ S01 ][1] );
        var C2 = new THREE.Color().setHex( cmap[ S02 ][1] );
