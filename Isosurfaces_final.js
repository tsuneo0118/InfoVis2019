function Isosurfaces( volume, isovalue, isocolor)
{
    ...
    isocolor = KVS.Clamp( isocolor, smin, smax );
    ...
    //document.write(isocolor);//チェック用
    var C0 = new THREE.Color().setHex( cmap[isocolor][1] );
